...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_65_ansi_blocker(
    ...
    ALT_TAB, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_HOME, \
  ...
  [1] = LAYOUT_65_ansi_blocker(
    ...
    _______, RGB_TOG, _______, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, _______, LAG_SWP,   Z_PIN,   Z_EDB,          KC_VOLU, KC_BRID, \
...
void matrix_scan_user(void) { // The very important timer.
  ...
  if (is_alt_tilde_active) {
    if (timer_elapsed(alt_tilde_timer) > 1000) {
      unregister_code(KC_LALT);
