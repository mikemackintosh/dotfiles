...
ZSH_THEME_GIT_PROMPT_ADDED="%{%F{110}%} added%{$rc%}"
ZSH_THEME_GIT_PROMPT_MODIFIED="%{%F{084}%} modified%{$rc%}"
ZSH_THEME_GIT_PROMPT_DELETED="%{%F{135}%} deleted%{$rc%}"
ZSH_THEME_GIT_PROMPT_RENAMED="%{%F{090}%} renamed%{$rc%}"
ZSH_THEME_GIT_PROMPT_UNMERGED="%{%F{060}%} unmerged%{$rc%}"
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{%F{208}%} untracked%{$rc%}"
